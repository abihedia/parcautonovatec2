...
class FleetContINHERITFact(models.Model):
    ...
    ############facture
    comp_couleur_after  = fields.Integer(string="Compteur Couleur")
    comp_couleur_before = fields.Integer(string="Compteur Couleur")
    comp_noir_after     = fields.Integer(string="Compteur NB")
